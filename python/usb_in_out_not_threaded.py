        ...
        if dev:
            try:
                while True:
                    ...
                    str_out.clear()
                    data = str_len_count.to_bytes(1, 'big') + str_len.to_bytes(str_len_count, 'big') + str_var + str_crc
                    str_out.extend(data)
                    try:
                    ...
                    #dev.send_feature_report(bytes(str_out))
                    dev.send_feature_report(b'07e33333333')
                    w  = 0x03e3
                    #dev.write(str_out)
                    ...
                    if data_in:
                        ...
                        try:
                            ...
                            print(f'len count: {len_count} | len: {len_data} | data: {received_data} | crc: {crc_data}')
